...
- 86 个全过。新增/改写：
  - cli.test.ts：默认只导 l1/l3；`--levels` 全量四级 + 体积排序；env 生效；flag 覆盖 env；非法回退默认
...
- wiki：reference/extension.md（env 表、触发点说明）、reference/cli.md（--levels）、
